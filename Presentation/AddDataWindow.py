...
class AddDataWindow(tk.Toplevel):
    ...
    def init_add_data_window(self):
        ...
        country_entry = tk.Entry(self, width=300)
        ...
        province_entry = tk.Entry(self, width=300)
        ...
        variety_entry = tk.Entry(self, width=300)
        ...
        year_entry = tk.Entry(self, width=300)
        ...
        points_entry = tk.Entry(self, width=300)
        ...
        price_entry = tk.Entry(self, width=300)
        ...
        taster_entry = tk.Entry(self, width=300)
