...
class AddDataWindow(tk.Toplevel):
    ...
    def init_add_data_window(self):
        ...
        country_entry = tk.Entry(self, width=100)
        ...
        province_entry = tk.Entry(self, width=100)
        ...
        variety_entry = tk.Entry(self, width=100)
        ...
        year_entry = tk.Entry(self, width=100)
        ...
        points_entry = tk.Entry(self, width=100)
        ...
        price_entry = tk.Entry(self, width=100)
        ...
        taster_entry = tk.Entry(self, width=100)
        taster_entry.grid(row=6, column=1, sticky='w', pady=3)

        taster_label = tk.Label(self, text='Описание:')
        taster_label.grid(row=6, column=0, sticky='w', padx=3, pady=3)
        taster_entry = tk.Entry(self, width=100)
        taster_entry.grid(row=6, column=1, sticky='w', pady=3)
